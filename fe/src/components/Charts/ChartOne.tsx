          ...
          <div className="inline-flex items-center rounded-md bg-whiter p-1.5 dark:bg-meta-4">
            ...
            <button onClick={() => setState(
              {
                series: [
                  {
                    name: 'Product One',
                    data: [12, 31, 42, 76, 32, 22, 76, 91, 44, 25, 36, 85],
                  },

                  {
                    name: 'Product Two',
                    data: [10, 25, 36, 30, 45, 35, 74, 52, 59, 36, 39, 31],
                  },
                ],
              }
            ...
            <button onClick={() => setState({
              series: [
                {
                  name: 'Product One',
                  data: [10, 25, 33, 30, 45, 25, 64, 52, 59, 36, 39, 51],

                },

                {
                  name: 'Product Two',
                  data: [23, 11, 32, 17, 13, 22, 27, 21, 34, 22, 30, 45],
