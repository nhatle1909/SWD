...
const Header = () => {
  ...
  const itemsProfile = [
    ...
    auth?.role !== "Admin" && auth?.role !== "Staff"
      ? {
          label: (
            <Menu style={{ width: 256 }} mode="vertical" items={itemsRequest} />
          ),
        }
      : null,
    auth?.role !== "Admin" && auth?.role !== "Staff"
    ...
    >
      <div className="container">
        <a className="navbar-brand" href="/">
          Interior Construction Quotation
        </a>
        <button
                  ...
                  <>
                    <Space>
                      <li
                        ...
                        className={`nav-item hover:cursor-pointer flex`}
                      >
                        <div className="nav-link !underline">{auth.email}</div>
                      </li>
                      <li>
                        <Avatar
                          onClick={() => {
                  ...
                  <>
                    <Space>
                      <li
                        ...
                        className={`nav-item hover:cursor-pointer flex`}
                      >
                        <div className="nav-link !underline">Login</div>
                        {openAuth ? <CaretDownOutlined /> : <CaretUpOutlined />}
                      </li>
                    </Space>
                  </>
                )}
